...
#include "../../Address_book/infowindow.h"
...
QT_MOC_LITERAL(1, 11, 10), // "clientshow"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "infowindow\0clientshow\0"
};
...
void infowindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (infowindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&infowindow::clientshow)) {
                *result = 0;
                return;
            }
        }
